...
def main():
    for dirpath, dirnames, filenames in os.walk(folder_in):
        ...
        vols = [TickerVolatility(os.path.join(dirpath, file), conn=child_conn) for file in filenames]
    ...
    for vol in vols:
        ...
        vol.start()
        print(f'{vol} process id:', os.getpid())
...
________________________POOL______________________
